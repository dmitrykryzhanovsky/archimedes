...
namespace Archimedes.Tests
{
    ...
    public class HeapTests
    {
        ...
        [TestMethod ()]
        public void InsertTest_TwoVariables_DaryMaxHeap ()
        {
            List<int> keyList   = new List<int> { 72, 7, 27, 61, 83, 47,  1 };
            List<int> valueList = new List<int> {  2, 3,  5,  7, 11, 13, 17 };
            ...
            Assert.AreEqual ((83, 11), heap [0]);
            Assert.AreEqual ((77, 19), heap [1]);
            Assert.AreEqual ((27,  5), heap [2]);
            Assert.AreEqual ((61,  7), heap [3]);
            Assert.AreEqual ((72,  2), heap [4]);
            Assert.AreEqual (( 7,  3), heap [5]);
            Assert.AreEqual (( 1, 17), heap [6]);
            Assert.AreEqual ((47, 13), heap [7]);
        }

        [TestMethod ()]
        public void InsertTest_Tuple_DaryMaxHeap ()
        {
            List<int> keyList   = new List<int> { 72, 7, 27, 61, 83, 47,  1 };
            List<int> valueList = new List<int> {  2, 3,  5,  7, 11, 13, 17 };
        ...
        [TestMethod ()]
        public void InsertTest_TwoVariables_DaryMinHeap ()
        {
            List<int> keyList   = new List<int> { 72, 7, 27, 61, 83, 47,  1 };
            List<int> valueList = new List<int> {  2, 3,  5,  7, 11, 13, 17 };
        ...
        [TestMethod ()]
        public void InsertTest_Tuple_DaryMinHeap ()
        {
            List<int> keyList   = new List<int> { 72, 7, 27, 61, 83, 47,  1 };
            List<int> valueList = new List<int> {  2, 3,  5,  7, 11, 13, 17 };
        ...
        [TestMethod ()]
        public void RemoveAtTest_DaryMaxHeap ()
        {
            List<int> keyList   = new List<int> { 15, 7, 9, 1,  2,  3,  8 };
            List<int> valueList = new List<int> {  2, 3, 5, 7, 11, 13, 17 };
        ...
        [TestMethod ()]
        public void RemoveAtTest_DaryMinHeap ()
        {
            List<int> keyList   = new List<int> { 15, 7, 9, 1,  2,  3,  8 };
            List<int> valueList = new List<int> {  2, 3, 5, 7, 11, 13, 17 };
            ...
            Assert.AreEqual (( 1,  7), heap [0]);
            Assert.AreEqual (( 3, 13), heap [1]);
            Assert.AreEqual (( 9,  5), heap [2]);
            Assert.AreEqual ((15,  2), heap [3]);
            Assert.AreEqual (( 8, 17), heap [4]);
            Assert.AreEqual (( 7,  3), heap [5]);
        }
    }
