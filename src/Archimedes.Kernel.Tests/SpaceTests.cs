...
namespace Archimedes.Tests
{
    ...
    public class SpaceTests
    {
        ...
        public void GetRotationMatrixAroundOYTest_Angle ()
        {
            ...
            Matrix3 expected = new Matrix3 (0.5, 0.0, -Math.Sqrt (3.0) / 2.0,
                                            0.0, 1.0, 0.0, 
                                            Math.Sqrt (3.0) / 2.0, 0.0, 0.5);

            Matrix3 actual = Space.GetRotationMatrixAroundOY (phi);
        ...
        public void GetRotationMatrixAroundOYTest_SineCosine ()
        {
            ...
            Matrix3 actual = Space.GetRotationMatrixAroundOY (sin, cos);
        ...
        public void GetRotationMatrixAroundOYBothTest_Angle ()
        {
            ...
            Matrix3 expectedDirect = new Matrix3 (0.5, 0.0, -Math.Sqrt (3.0) / 2.0,
                                                  0.0, 1.0, 0.0,
                                                  Math.Sqrt (3.0) / 2.0, 0.0, 0.5);

            Matrix3 expectedBackward = new Matrix3 (0.5, 0.0, Math.Sqrt (3.0) / 2.0,
                                                    0.0, 1.0, 0.0,
                                                    -Math.Sqrt (3.0) / 2.0, 0.0, 0.5);

            (Matrix3 actualDirect, Matrix3 actualBackward) = Space.GetRotationMatrixAroundOYBoth (phi);
        ...
        public void GetRotationMatrixAroundOYBothTest_SineCosine ()
        {
            ...
            (Matrix3 actualDirect, Matrix3 actualBackward) = Space.GetRotationMatrixAroundOYBoth (sin, cos);
        ...
        public void RotateVectorAroundOYTest_Angle ()
        {
            ...
            Vector3 actual = Space.RotateVectorAroundOY (v, phi);
        ...
        public void RotateVectorAroundOYTest_SineCosine ()
        {
            ...
            Vector3 actual = Space.RotateVectorAroundOY (v, sin, cos);
