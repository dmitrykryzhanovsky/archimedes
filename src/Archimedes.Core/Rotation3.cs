...
{
    /// <summary>
    /// Вращения в 3-мерном пространстве.
    /// </summary>
    ...
    public static class Rotation3
    {
        ...
        public static class GetRotationMatrix
        {
            ...
            /// <summary>
            /// Пассивные повороты (системы координат на заданные углы).
            /// </summary>
        ...
        public static class Apply
        {
            ...
            /// </summary>
            public static Vector3 Rotate (Matrix3 rotationMatrix, Vector3 v)
            {
            ...
            public static class Passive
            {
                ...
                public static class EulerAngles
                {
                    ...
                    /// координат, заданного углами Эйлера.
                    /// </summary>
                    /// <param name="alpha">Угол прецессии – поворот оси OX до линии узлов.</param>
                    /// <param name="beta">Угол нутации – наклон оси OZ.</param>
                    /// <param name="gamma">Угол собственного вращения – поворот оси OX от линии узлов до её нового положения.</param>
                    ...
                    /// производится.</item>
                    /// </list></remarks>
                    public static Polar3 RotateSpace (Polar3 p, double sinA, double cosA, double sinB, double cosB, double sinG, 
                        double cosG)
                    {
                    ...
                    /// <summary>
                    /// Метод для расчёта полярных координат – широты и долготы вектора p – в новой системе координат, полученной 
                    /// после поворота старой системы координат, заданного синусами и косинусами углов Эйлера.
                    /// </summary>
                    ...
                    private static (double latitude, double longitude) ComputeNewAngles (Polar3 p, double sinA, double cosA, 
                        double sinB, double cosB, double sinG, double cosG)
                    {
                        (double sinPhi, double cosPhi) = double.SinCos (p.Lat);
                        (double sinL, double cosL) = double.SinCos (p.Long);
                        ...
                        return (latitude: Trigonometry.AsinEpsilon (sinPhi1), longitude: Trigonometry.Atan2Epsilon (dy, dx));
                    }
                }
            }
        }
