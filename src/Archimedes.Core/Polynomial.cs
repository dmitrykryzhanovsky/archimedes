namespace Archimedes
{
    public static class Polynomial
    {
        ...
        {
            return SquareNoConstantTerm (x, a) + a [0];
        }
        ...
        {
            return CubeNoConstantTerm (x, a) + a [0];
        }
        ...
        private static double SquareNoConstantTerm (double x, params double [] a)
        {
            return (a [2] * x + a [1]) * x;
        }

        private static double CubeNoConstantTerm (double x, params double [] a)
        {
