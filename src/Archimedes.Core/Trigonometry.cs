namespace Archimedes
{
    public static class Trigonometry
    {
        ...
        {
            return x * AngularUnits.DegToRad;
        }
        ...
        {
            return deg.Phase (AngularUnits.DegInOrbit);
        }
        ...
        {
            return hour.Phase (AngularUnits.HourInOrbit);
        }
        ...
        {
            return NormalizeHalfTurn (deg, AngularUnits.DegInOrbit, AngularUnits.DegInHalfOrbit);
        }
        ...
        {
            return NormalizeHalfTurn (hour, AngularUnits.HourInOrbit, AngularUnits.HourInHalfOrbit);
        }
